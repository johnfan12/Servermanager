...
# Docker commit 快照超时（秒）
SNAPSHOT_COMMIT_TIMEOUT_SECONDS = int(
    os.environ.get("SNAPSHOT_COMMIT_TIMEOUT_SECONDS", "600")
)
if SNAPSHOT_COMMIT_TIMEOUT_SECONDS < 60:
    SNAPSHOT_COMMIT_TIMEOUT_SECONDS = 60
